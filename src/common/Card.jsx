...
export const Card = ({ currPosition }) => {
    return (
        ...
        <div className="flex flex-col items-center justify-center p-4 min-w-[200px] w-[200px] max-h-min bg-white rounded-3xl space-y-3 ">
            ...
            <div className="flex flex-col items-center space-y-1">
                ...
                <h3 className=" text-center [font-family:'Inter-Bold',Helvetica] font-normal text-black text-[1.3rem] tracking-[-0.80px] leading-[normal]">{currPosition.name}</h3>
