    ...
    return (
        <div className="flex flex-col items-start relative self-stretch w-full rounded-[20px]  border-2 border-solid border-[#f7f7f7]">
            <div className="flex items-center justify-between p-[1rem] relative self-stretch w-full  bg-[#f7f7f7] rounded-[20px_20px_0px_0px] transition-all duration-1000" >
                <div className="relative max-w-[80%] [font-family:'Inter',Helvetica] font-medium text-black text-[1.4rem] tracking-[-1px] leading-[normal] cursor-pointer" onClick={(e) => {changeAnswerHandler(e)} }>
            ...
            {
                show && <div className="flex items-start gap-[10px] p-[1rem] relative self-stretch w-full transition-all duration-1000">
